...
| Seed data | Alex's demo account fully populated | Balance £1,247.50, 2 pots, 5 beneficiaries, 60 days transactions, 1 standing order, credit score 742 |
| Test constants | `packages/shared/src/test-constants.ts` | Single source of truth for all test values. Imported by seed scripts and test fixtures |
